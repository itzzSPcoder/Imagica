...
export const getListSketchesUrl = () => {
 ...
 */
export const listSketches = async ( options?: RequestInit): Promise<Sketch[]> => {

  return customFetch<Sketch[]>(getListSketchesUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListSketchesQueryKey = () => {
    return [
    `/api/sketches`
    ] as const;
    }
...
export const getListSketchesQueryOptions = <TData = Awaited<ReturnType<typeof listSketches>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listSketches>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListSketchesQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listSketches>>> = ({ signal }) => listSketches({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listSketches>>, TError, TData> & { queryKey: QueryKey }
}

export type ListSketchesQueryResult = NonNullable<Awaited<ReturnType<typeof listSketches>>>
export type ListSketchesQueryError = ErrorType<unknown>
...
export function useListSketches<TData = Awaited<ReturnType<typeof listSketches>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listSketches>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListSketchesQueryOptions(options)
...
export const getCreateSketchUrl = () => {
 ...
 */
export const createSketch = async (sketchInput: SketchInput, options?: RequestInit): Promise<Sketch> => {

  return customFetch<Sketch>(getCreateSketchUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(sketchInput)
  }
);}
...
export const getCreateSketchMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createSketch>>, TError,{data: BodyType<SketchInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createSketch>>, TError,{data: BodyType<SketchInput>}, TContext> => {

const mutationKey = ['createSketch'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createSketch>>, {data: BodyType<SketchInput>}> = (props) => {
          const {data} = props ?? {};

          return  createSketch(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateSketchMutationResult = NonNullable<Awaited<ReturnType<typeof createSketch>>>
    export type CreateSketchMutationBody = BodyType<SketchInput>
    export type CreateSketchMutationError = ErrorType<unknown>

    /**
 * @summary Upload a sketch image and get generated code
 */
export const useCreateSketch = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createSketch>>, TError,{data: BodyType<SketchInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createSketch>>,
        TError,
        {data: BodyType<SketchInput>},
        TContext
      > => {
      return useMutation(getCreateSketchMutationOptions(options));
    }

export const getGetSketchUrl = (id: number,) => {




  return `/api/sketches/${id}`
}

/**
 * @summary Get a sketch by ID
 */
export const getSketch = async (id: number, options?: RequestInit): Promise<Sketch> => {

  return customFetch<Sketch>(getGetSketchUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetSketchQueryKey = (id: number,) => {
    return [
    `/api/sketches/${id}`
    ] as const;
    }
...
export const getGetSketchQueryOptions = <TData = Awaited<ReturnType<typeof getSketch>>, TError = ErrorType<ApiError>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSketch>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetSketchQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getSketch>>> = ({ signal }) => getSketch(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSketch>>, TError, TData> & { queryKey: QueryKey }
}

export type GetSketchQueryResult = NonNullable<Awaited<ReturnType<typeof getSketch>>>
export type GetSketchQueryError = ErrorType<ApiError>
...
export function useGetSketch<TData = Awaited<ReturnType<typeof getSketch>>, TError = ErrorType<ApiError>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSketch>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetSketchQueryOptions(id,options)
...
export const getDeleteSketchUrl = (id: number,) => {
 ...
 */
export const deleteSketch = async (id: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getDeleteSketchUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteSketchMutationOptions = <TError = ErrorType<ApiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteSketch>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteSketch>>, TError,{id: number}, TContext> => {

const mutationKey = ['deleteSketch'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteSketch>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  deleteSketch(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteSketchMutationResult = NonNullable<Awaited<ReturnType<typeof deleteSketch>>>

    export type DeleteSketchMutationError = ErrorType<ApiError>

    /**
 * @summary Delete a sketch
 */
export const useDeleteSketch = <TError = ErrorType<ApiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteSketch>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteSketch>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getDeleteSketchMutationOptions(options));
    }

export const getRegenerateSketchUrl = (id: number,) => {




  return `/api/sketches/${id}/regenerate`
}

/**
 * @summary Regenerate code for an existing sketch with optional instructions
 */
export const regenerateSketch = async (id: number,
    regenerateInput: RegenerateInput, options?: RequestInit): Promise<Sketch> => {

  return customFetch<Sketch>(getRegenerateSketchUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getRegenerateSketchMutationOptions = <TError = ErrorType<ApiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof regenerateSketch>>, TError,{id: number;data: BodyType<RegenerateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof regenerateSketch>>, TError,{id: number;data: BodyType<RegenerateInput>}, TContext> => {

const mutationKey = ['regenerateSketch'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof regenerateSketch>>, {id: number;data: BodyType<RegenerateInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  regenerateSketch(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RegenerateSketchMutationResult = NonNullable<Awaited<ReturnType<typeof regenerateSketch>>>
    export type RegenerateSketchMutationBody = BodyType<RegenerateInput>
    export type RegenerateSketchMutationError = ErrorType<ApiError>

    /**
 * @summary Regenerate code for an existing sketch with optional instructions
 */
export const useRegenerateSketch = <TError = ErrorType<ApiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof regenerateSketch>>, TError,{id: number;data: BodyType<RegenerateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof regenerateSketch>>,
        TError,
        {id: number;data: BodyType<RegenerateInput>},
        TContext
      > => {
      return useMutation(getRegenerateSketchMutationOptions(options));
    }

export const getGetSketchStatsUrl = () => {




  return `/api/sketches/stats`
}

/**
 * @summary Get summary stats for the sketch history
 */
export const getSketchStats = async ( options?: RequestInit): Promise<SketchStats> => {

  return customFetch<SketchStats>(getGetSketchStatsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetSketchStatsQueryKey = () => {
    return [
    `/api/sketches/stats`
    ] as const;
    }
...
export const getGetSketchStatsQueryOptions = <TData = Awaited<ReturnType<typeof getSketchStats>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSketchStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetSketchStatsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getSketchStats>>> = ({ signal }) => getSketchStats({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSketchStats>>, TError, TData> & { queryKey: QueryKey }
}

export type GetSketchStatsQueryResult = NonNullable<Awaited<ReturnType<typeof getSketchStats>>>
export type GetSketchStatsQueryError = ErrorType<unknown>
...
export function useGetSketchStats<TData = Awaited<ReturnType<typeof getSketchStats>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSketchStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetSketchStatsQueryOptions(options)
...
export const getGetPaymentPlanUrl = () => {




  return `/api/payments/plan`
}

/**
 * @summary Get the user's current payment plan and conversion usage
 */
export const getPaymentPlan = async ( options?: RequestInit): Promise<PaymentPlanStatus> => {

  return customFetch<PaymentPlanStatus>(getGetPaymentPlanUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetPaymentPlanQueryKey = () => {
    return [
    `/api/payments/plan`
    ] as const;
    }
...
export const getGetPaymentPlanQueryOptions = <TData = Awaited<ReturnType<typeof getPaymentPlan>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPaymentPlan>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetPaymentPlanQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getPaymentPlan>>> = ({ signal }) => getPaymentPlan({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPaymentPlan>>, TError, TData> & { queryKey: QueryKey }
}

export type GetPaymentPlanQueryResult = NonNullable<Awaited<ReturnType<typeof getPaymentPlan>>>
export type GetPaymentPlanQueryError = ErrorType<unknown>
...
export function useGetPaymentPlan<TData = Awaited<ReturnType<typeof getPaymentPlan>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPaymentPlan>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetPaymentPlanQueryOptions(options)
...
/**
 * @summary Create a new billing checkout session
 */
export const createCheckoutSession = async ( options?: RequestInit): Promise<CheckoutSessionResponse> => {
